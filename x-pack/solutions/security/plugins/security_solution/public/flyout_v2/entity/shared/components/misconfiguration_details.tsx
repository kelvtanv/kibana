...
export interface MisconfigurationDetailsProps {
  /**
...
export const MisconfigurationDetails = memo(
  ({ resourceId, ruleId }: MisconfigurationDetailsProps) => {
    ...
    if (isLoading) {
      return <FlyoutLoading data-test-subj="misconfiguration-details-loading" />;
    }
...
MisconfigurationDetails.displayName = 'MisconfigurationDetails';
